...
class InfoSocorristaScreen extends StatelessWidget {
  final Usuario socorrista;

  const InfoSocorristaScreen({super.key, required this.socorrista});
              ...
              children: [
                ...
                if (poolsDelSocorrista.isEmpty)
                  ...
                  Column(
                    children: poolsDelSocorrista.map((pool) {
                      ...
                      final turnosDeEstePool = socorrista.turnos
                ...
                Column(
                  ...
                  children: meses.map((mes) {
                    ...
                    final Duration duracionPlanificada = socorrista
                ...
                if (authService.usuario.value!.isAdmin) ...[
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: meses.map((mes) {
                      final double importeMes = socorrista.importeAPagarEnMes(
                        anyo,
                        mes,
                      );
